...
| `analysis.py` | Training solve rate, latent frontier support, ER@1/ER@2, behavioural recovery, solve curves S(B), first-solution ranks, recovery conditional on support, exposure transitions, gap closure against B / PWS_B / O, per-cohort causal-chain deltas. Reads the Phase 1 evaluation records as comparison arms. |
