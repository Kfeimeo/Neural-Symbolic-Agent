...
class Recognition(nn.Module):
    def __init__(self,grammar,feature_dim=40,hidden=64):
        super().__init__()
    ...
    def search_grammar(self,features):
        ...
        with torch.no_grad(): g["contexts"]=dict(zip(self.keys,self(features).tolist()))
        return g
    def fit_frontiers(self,kernel,data,steps=50,seed=0,objective="bias_optimal"):
        ...
        for features,frontier in data:
            ...
            prepared.append((features,scored,summaries))
